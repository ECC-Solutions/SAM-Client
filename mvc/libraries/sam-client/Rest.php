...
class REST
{
    ...
    function __construct($config = array())
    {
		...
		*/
		$this->_ci->load->library('sam-client/curl');
    ...
    {        
		...
		{                    
                ...
                //$this->http_header('Content-type', $this->mime_type); //added 26 augest 2013 by ahmed saber to force use the header defined in the wrapper
